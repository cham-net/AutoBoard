...
//    var itemsTest = [
//        UIImage(named: "m1"), UIImage(named: "m2"), UIImage(named: "m3"), UIImage(named: "m4"), UIImage(named: "m5"), UIImage(named: "m6")
//    ]
    
    //var z = self.testImage.aImage
    
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        //testImage.aImage.count
        return 10
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.imageAnn.downloadedFrom(link: "\(item.aImage[indexPath.row])")
        return cell
    }
